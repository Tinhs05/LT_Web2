        ...
        <div class="headbox" id="headbox">
           <!-- <div><picture></picture></div> -->
                ...
                <form class="headcenter" class="form-search">
                     ...
                     <input type="text" id="form-search-product" type="text" class="form-search-input inputsearch" placeholder="TÌm kiếm sản phẩm"  onchange="searchform()">
                ...
                <div class="headerright">
                    <div class="headerright-click ">
                       <div id="AccountLogin">
                           ...
                           <a href="?module=auth&action=login" style="color: #333; text-decoration: none;">Đăng nhập</a>
                        </button>
                        </div>
                    ...
                    <a href="?module=user&action=cart"><div class="headerright-click"><button onclick="openCart()"> <i class="fa-regular fa-cart-shopping"></i></button></div></a>
